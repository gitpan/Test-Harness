...
Currently Test::Harness does nothing with the description but we plan
...
is not guaranteed in the future.  If you want to place additional output
in your test script, please use a diagnostic line.
...
Paul Johnson
and
Ian Langworth for help and contributions.
